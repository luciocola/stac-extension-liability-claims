= STAC Liability and Claims Extension - Engineering Report
...
:external-id: http://www.opengis.net/doc/PER/stac-liability-claims
:comment: ### Author one
...
:keywords: STAC, liability, claims, provenance, W3C PROV, ISO 19115, data quality, geospatial metadata, semantic web
